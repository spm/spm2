...
% for Functional MRI.  Submitted to MRM (April 1999) and available from:
...
% explained by a model for susceptibility-by-movement interactions. This
...
% no longer nice and homogeneous. Since varying field strength (gradients)
...
% direction). The distortions are noticeable mainly near air-tissue
% interfaces inside the scull, i.e. near the sinuses and the auditory
% canals. 
%
% In these areas in particular the observed image is a severely warped 
...
% at another. We call this effect susceptibility-by-movement interaction. 
% The "Unwarp" toolbox is predicated on the assumption that the 
% susceptibility-by-movement interaction is responsible for a sizeable 
...
% the susceptibility-by-movement interaction. Since the underlying model 
...
% performed completely independently between each of the fMRI sessions.
%
% 'Images, subject # ..'
...
% `coregistration' modules.  What these matrices contain is a mapping from
